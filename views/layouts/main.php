    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="/public/images/blog-icon.png" alt=""></a>
            </div>
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2022 <a href="#">PHP-BLOG, </a> Built with <i
                                class="fa fa-heart"></i> by <a href="#">Lebedeva Natalya</a>
                    </div>
                </div>
            </div>
        </div>
